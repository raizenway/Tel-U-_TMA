...
interface JakartaTabProps {
  setIsFormDirty: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function JakartaTab({ setIsFormDirty }: JakartaTabProps) {
  ...
  const handleConfirm = () => {
    ...
    const newEntry = {
      id: Date.now(),
      unit: "Tel-U Jakarta", // 👈 Hanya ini yang berubah dari Purwokerto
    ...
    <div className="max-w-7xl mx-auto px-6 py-10 min-h-screen bg-gray">
      ...
      <ModalConfirm
        ...
        onConfirm={() => {
          ...
          localStorage.setItem("assessment_submission_jakarta", JSON.stringify(submissionData));
