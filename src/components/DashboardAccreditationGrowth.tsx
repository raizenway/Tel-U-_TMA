...
export default function DashboardAccreditationGrowth() {
    ...
    const [localAccreditationGrowthByCampus, setLocalAccreditationGrowthByCampus] = useState([]);
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const accreditationGrowthByCampus = localAccreditationYears.map((year, idx) => ({
                tahun: year,
                Jakarta: accreditationInputData["Tel-U Jakarta"][idx] ?? 0,
                Bandung: accreditationInputData["Tel-U Bandung"][idx] ?? 0,
                Purwokerto: accreditationInputData["Tel-U Purwokerto"][idx] ?? 0,
            ...
            setLocalAccreditationGrowthByCampus(accreditationGrowthByCampus)
        ...
        <div>
            <div className="bg-white rounded-xl shadow p-6">
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={localAccreditationGrowthByCampus} key={localAccreditationGrowthByCampus.length}>
